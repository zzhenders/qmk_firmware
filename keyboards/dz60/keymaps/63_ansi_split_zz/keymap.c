...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_60_ansi_split(
		...
		KC_NO, KC_NO, KC_BTN4, KC_MS_U, KC_BTN5, KC_NO, KC_NO, KC_NO, KC_BTN3, KC_WH_D, KC_NO, KC_NO, KC_NO, KC_NO, 
		KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO, KC_BTN1, KC_BTN2, KC_WH_U, KC_NO, KC_NO, KC_NO, 
		KC_NO, KC_NO, KC_NO, KC_NO, KC_ACL1, KC_ACL2, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
		KC_NO, KC_NO, KC_NO, KC_ACL0, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO
	),
};
